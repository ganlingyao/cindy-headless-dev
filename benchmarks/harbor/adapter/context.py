...
class AgentContext(BaseModel):
    _execution_timeout_sec: float | None = PrivateAttr(default=None)
    ...
    @property
    def execution_timeout_sec(self) -> float | None:
        return self._execution_timeout_sec

    def set_execution_timeout_sec(self, value: float | None) -> None:
        self._execution_timeout_sec = value
