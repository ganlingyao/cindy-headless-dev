...
if (manifest.schemaVersion !== 3 || manifest.headlessContractVersion !== 1) throw new Error('unsupported bundle manifest schema or contract');
for (const [name, expected] of [['claude', manifest.claudeBinaryDigest], ['codex', manifest.codexBinaryDigest]]) {
...
console.log(JSON.stringify({ ok: true, manifestSchema: manifest.schemaVersion, headlessContractVersion: manifest.headlessContractVersion, cindyHeadlessVersion: manifest.cindyHeadlessVersion ?? '0.1.0', claudeCodeVersion: manifest.claudeCodeVersion, codexVersion: manifest.codexVersion }, null, 2));
