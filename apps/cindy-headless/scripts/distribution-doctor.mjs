...
try {
  ...
  checks.push({ name: 'bundle', ok: manifest.schemaVersion === 4 && manifest.headlessContractVersion === 1 && Boolean(manifest.nodeBinaryDigest && manifest.nodeVersion), detail: manifest.cindyCommit });
